...
const Step_4 = () => {
  ...
  let arcade_fee = usersPlanReducer.periodType === 'monthly' ? 20 : 90,
    advance_fee = usersPlanReducer.periodType === 'monthly' ? 12 : 150,
    ...
    <>
      <section id="step_4">
        ...
        <div className="part_2">
          <div className="b1">
            <div className="part_1">
              <h3 className="billing">
                {usersPlanReducer.planType} ({usersPlanReducer.periodType})
              </h3>
                ...
                <span>
                  {
                    ...
                    usersPlanReducer.planType === 'Monthly'
                      ? usersPlanReducer.periodType === 'monthly'
                        ? '$20/mo'
                        : ''
                      : usersPlanReducer.planType === 'Yearly'
                      ? usersPlanReducer.periodType === 'monthly'
                        ? ''
                        : '$150/yr'
                      : usersPlanReducer.planType === 'pro'
                      ? usersPlanReducer.periodType === 'monthly'
                        ? '$15/mo'
                        : '$150/yr'
                      : ''
                        ...
                        <span>
                          {
                            ...
                            elem.addOn === 'Online Service'
                              ? usersPlanReducer.periodType === 'monthly'
                                ? '+$1/mo'
                                : '+$10/yr'
                              : elem.addOn === 'Larger Storage'
                              ? usersPlanReducer.periodType === 'monthly'
                                ? '+$2/mo'
                                : '+$20/yr'
                              : elem.addOn === 'Customizable Profile'
                              ? usersPlanReducer.periodType === 'monthly'
                                ? '+$2/mo'
                                : '+$20/yr'
                              : ''
        ...
        <div className="part_3">
          <div className="part_1">
            <p className="total_type">
              Total ({usersPlanReducer.periodType === 'monthly' ? 'per month' : 'per year'})
            </p>
          </div>

          <div className="part_2">
            <p className="total_price">
              {usersPlanReducer.periodType === 'arcade' ? `+$${Total}/mo` : `$${Total}/yr`}
            </p>
          </div>
        </div>
