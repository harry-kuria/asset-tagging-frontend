...
const Step_1 = () => {
  ...
  const handleNextStep = () => {
    ...
    if (
      ...
      nameInput.current.value.match(valid_name) &&
      emailInput.current.value.match(valid_email) &&
      phoneInput.current.value.match(valid_phone) &&
      phoneInput.current.value.length === 10
    ) {
      phoneInput.current.value = phoneInput.current.value.replace(
        /(\d{1})(\d{3})(\d{3})(\d{3})/,
        '+$1 $2 $3 $4',
      )
      dispatch(
        addInfoAction(nameInput.current.value, emailInput.current.value, phoneInput.current.value),
      )
      ...
      if (
        ...
        phoneInput.current.style = 'border: 1px solid var(--Strawberry-red)'
        phoneInput.current.parentNode.querySelector('.error').innerText =
          'Ten Numbers only required'
        phoneInput.current.parentNode.querySelector('.error').style = 'display: block'
      }
    }
  }
          ...
          <form className="info_form">
            <div>
              ...
              <input
                ...
                name="name"
                id="name"
                defaultValue={usersInfoReducer.name}
            ...
            <div>
              ...
              <input
                ...
                name="email"
                id="email"
                defaultValue={usersInfoReducer.email}
            ...
            <div>
              ...
              <input
                ...
                name="phone"
                id="phone"
                defaultValue={usersInfoReducer.phone}
